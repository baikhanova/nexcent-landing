    ...
    return (
        <section id="testimonial" className="bg-gray-100 py-10">
            <div className="container mx-auto flex flex-col md:flex-row items-center gap-16 px-6">
                <img src="/assets/tesla.svg" alt="Citation" />
                <div className="flex-1">
                    ...
                    <p className="text-green-600 text-md font-medium mb-2 mr-10">Tim Smith</p>
                    <p className="text-gray-400 text-sm font-light mb-6 mr-10">British Dragon Boat Racing Association</p>
