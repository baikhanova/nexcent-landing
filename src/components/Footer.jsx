...
export default function Footer() {
    return (
        <footer style={{ backgroundColor: "#263238" }} className="py-10 text-sm text-white">
            <div className="container mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                <div>
                    ...
                    <div className="flex gap-3 mt-4 pt-3">
                        {["instagram", "dribble", "twitter", "youtube"].map((name) => (
                            <a
                                key={name}
                                href="#"
                                aria-label={name}
                            ...
                            >
                                <img src={`/assets/${name}Icon.svg`} alt={name} />
                            </a>
                        ))}
                    </div>
                </div>
                ...
                <div>
                    ...
                    <form className="flex items-center bg-gray-600 rounded-md px-4 py-2 max-w-xs w-full">
                        <input
                            type="email"
